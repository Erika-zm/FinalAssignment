...
destfile = "/home/erika07/Desktop/Dataset.zip", 
method = "curl")
...
test.train2 = aggregate(. ~subject + activity, test.train, mean)
write.table(test.train2, file = "tidydata.txt", row.name=FALSE)
